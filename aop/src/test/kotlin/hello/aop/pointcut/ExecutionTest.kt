...
class ExecutionTest {
    ...
    @Test
    fun printMethod() {
        // 결과 helloMethod=public java.lang.String hello.aop.member.MemberServiceImpl.hello(java.lang.String)
    ...
    fun typeMatchInternal() {
        ...
        val internal = MemberServiceImpl::class.java.getMethod("internal", String::class.java)
        assertThat(pointcut.matches(internal, MemberServiceImpl::class.java)).isTrue
    }
    ...
    fun typeMatchNoSuperTypeMethodFalse() {
        ...
        val internal = MemberServiceImpl::class.java.getMethod("internal", String::class.java)
        assertThat(pointcut.matches(internal, MemberServiceImpl::class.java)).isFalse
    }
